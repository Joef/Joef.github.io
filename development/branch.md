...
![branching](../images/branching.png ":size=100%")

### Branch Name/Commit Messages/Pull Requests

Any branch for a ticket should be named after its ticket idendifier, i.e. `feature/project-2321`. Commit messages should begin with the ticket name in brackets, i.e. "[project-2321] _Commit Message_".  Finally, a PR title should be named with the ticket, [project-2321].
